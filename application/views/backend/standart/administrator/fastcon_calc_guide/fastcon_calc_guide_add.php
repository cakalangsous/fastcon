...
<section class="content-header">
    <h1>
        AAC Calculator Guide        <small><?= cclang('new', ['AAC Calculator Guide']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['AAC Calculator Guide']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <textarea id="guide" name="guide" rows="5" cols="80"><?= set_value('Guide'); ?></textarea>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/fastcon_calc_guide/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
