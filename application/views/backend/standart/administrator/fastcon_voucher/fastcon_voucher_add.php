                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="min_purchase" id="min_purchase" placeholder="Min Purchase" value="<?= set_value('min_purchase'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datepicker" name="start_date"  placeholder="Start Date" id="start_date">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="col-md-2 padding-left-0">
                                    <label>
                                        <input type="radio" class="flat-red" name="active" id="active"  value="1">
                                        <?= cclang('yes'); ?>
                                    </label>
                                </div>
                                <div class="col-md-14">
                                    <label>
                                        <input type="radio" class="flat-red" name="active" id="active"  value="0">
                                        <?= cclang('no'); ?>
                                    </label>
                                </div>
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/fastcon_voucher/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            ...
            voucher_description.setData('');
            voucher_description_en.setData('');
