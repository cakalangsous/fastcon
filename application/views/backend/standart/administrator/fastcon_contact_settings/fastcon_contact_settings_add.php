...
<section class="content-header">
    <h1>
        Contact Settings        <small><?= cclang('new', ['Contact Settings']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Contact Settings']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="setting_item" id="setting_item" placeholder="Setting Item" value="<?= set_value('setting_item'); ?>">
                            ...
                            <div class="col-sm-8">
                                <textarea id="setting_value" name="setting_value" rows="5" cols="80"><?= set_value('Setting Value'); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/fastcon_contact_settings/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
