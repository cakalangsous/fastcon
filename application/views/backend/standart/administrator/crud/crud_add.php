            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="form-group ">
                     ...
                     <label for="label" class="col-sm-2 control-label"><?= cclang('title') ?> <i class="required">*</i></label>
                     ...
                     <div class="col-sm-7">
                        ...
                        <div class="col-xs-3">
                          ...
                          <label>
                            ...
                            <input class="flat-red check page_clone" type="checkbox" id="clone" value="yes" name="clone" checked> <?= cclang('clone'); ?> 
