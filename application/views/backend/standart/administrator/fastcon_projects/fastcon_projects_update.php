...
<section class="content-header">
    <h1>
        Projects        <small>Edit Projects</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Projects</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/fastcon_projects/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="category" id="category" data-placeholder="Select Category" >
                                    ...
                                    <option <?=  $row->category_id ==  $fastcon_projects->category ? 'selected' : ''; ?> value="<?= $row->category_id ?>"><?= $row->category_name; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                            ...
                            <div class="col-sm-8">
                                ...
                                <div id="fastcon_projects_images_galery_listed">
                                <?php foreach ((array) explode(',', $fastcon_projects->images) as $idx => $filename): ?>
                                    <input type="hidden" class="listed_file_uuid" name="fastcon_projects_images_uuid[<?= $idx ?>]" value="" /><input type="hidden" class="listed_file_name" name="fastcon_projects_images_name[<?= $idx ?>]" value="<?= $filename; ?>" />
                                <?php endforeach; ?>
                                </div>
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="title" id="title" placeholder="Title" value="<?= set_value('title', $fastcon_projects->title); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="title_en" id="title_en" placeholder="Title En" value="<?= set_value('title_en', $fastcon_projects->title_en); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="slug" id="slug" placeholder="Slug" value="<?= set_value('slug', $fastcon_projects->slug); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <textarea id="short_desc" name="short_desc" rows="5" class="textarea"><?= set_value('short_desc', $fastcon_projects->short_desc); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <textarea id="short_desc_en" name="short_desc_en" rows="5" class="textarea"><?= set_value('short_desc_en', $fastcon_projects->short_desc_en); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <textarea id="content" name="content" rows="10" cols="80"> <?= set_value('content', $fastcon_projects->content); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <textarea id="content_en" name="content_en" rows="10" cols="80"> <?= set_value('content_en', $fastcon_projects->content_en); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-6">
                                <div class="col-md-2 padding-left-0">
                                    <label>
                                        <input type="radio" class="flat-red" name="featured" id="featured"  value="yes" <?= $fastcon_projects->featured == "yes" ? "checked" : ""; ?>>
                                        Yes
                                    </label>
                                </div>
                                <div class="col-md-14">
                                    <label>
                                        <input type="radio" class="flat-red" name="featured" id="featured"  value="no" <?= $fastcon_projects->featured == "no" ? "checked" : ""; ?>>
                                        No
                                    </label>
                                </div>
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: form_fastcon_projects.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id = $('#fastcon_projects_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
       ...
       $('#fastcon_projects_images_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'administrator/fastcon_projects/get_images_file/<?= $fastcon_projects->id; ?>',
