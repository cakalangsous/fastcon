                  ...
                  <div class="widget-user-header ">
                    ...
                    <div class="row-fluid">
                      ...
                      <div class="nav-tabs-custom">
                       ...
                       <?= form_open_multipart('administrator/setting/save', [
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6">
                                ...
                                <div class="col-sm-12">
                                  ...
                                  <!-- Add logo for site 2 Mei 2018 Benkin -->
                                 <div class="col-sm-12">

                                    <label>Logo<span class="required">*</span></label>
                                    <?php if (get_option('site_logo')) {?>
                                      <div><img src="<?=BASE_ASSET?>logo/<?= get_option('site_logo')?get_option('site_logo'):'' ?>" width="130"></div>
                                    <?php } ?>

                                    <input type="file" class="form-control data_file" name="site_logo" id="site_logo">

                                    <small class="info help-block">Site logo.</small>

                                </div>

                                <div class="col-sm-12">

                                    <label>Logo Small<span class="required">*</span></label>
                                    <?php if (get_option('site_logo_small')) {?>
                                      <div><img src="<?=BASE_ASSET?>logo/<?= get_option('site_logo_small')?get_option('site_logo_small'):'' ?>" width="70"></div>
                                    <?php } ?>

                                    <input type="file" class="form-control data_file" name="site_logo_small" id="site_logo_small">

                                    <small class="info help-block">Site small logo.</small>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <?php if (get_option('site_favicon')) {?>
                                      <div><img src="<?=BASE_ASSET?>logo/<?= get_option('site_favicon')?get_option('site_favicon'):'' ?>" width="16"></div>
                                    <?php } ?>

                                    <input type="file" class="form-control data_file" name="site_favicon" id="site_favicon">

                                    <small class="info help-block">Site favicon.</small>

                                </div>

                                <div class="col-sm-12">

                                    <label>Login Background<span class="required">*</span></label>
                                    <?php if (get_option('login_bg')) {?>
                                      <div><img src="<?=BASE_ASSET?>logo/<?= get_option('login_bg')?get_option('login_bg'):'' ?>" width="130"></div>
                                    <?php } ?>

                                    <input type="file" class="form-control data_file" name="login_bg" id="login_bg">

                                    <small class="info help-block">Site login background.</small>
                                ...
                                <div class="col-sm-12">
                                  ...
                                  <!-- setting skin 2 Mei 2018 Benkin -->

                                  <div class="col-sm-12">

                                      <label>Skin <span class="required">*</span></label>
                                        ...
                                        <div class="col-md-6 ">
                                          ...
                                          <select class="form-control" name="skin" id="skin">
                                            ...
                                            <?php
                                              ...
                                              $current_skin = get_option('skin');

                                             foreach ($skins as $skin) {

                                               ?>

                                               <option <?=($current_skin==$skin->option_value)?'selected':''?> value="<?= $skin->option_value ?>"><?= $skin->option_name ?></option>
                    ...
                    <!-- <div class="message no-message-padding"> -->
                      ...
                      <?=(!empty($this->session->flashdata('response')))?$this->session->flashdata('response'):'' ?>

                    <!-- </div> -->

                        <?php is_allowed('setting_update', function(){?>
                        <!-- add this class -> 'btn_save' to button save to run ajax -->
                        <button type="submit" class="btn btn-flat btn-default btn_action" id="btn_save" data-stype='stay' title="save (Ctrl+s)"><i class="fa fa-save" ></i> <?= cclang('save_button'); ?></button>
