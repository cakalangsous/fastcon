                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="product_slug" id="product_slug" placeholder="Product Slug" value="<?= set_value('product_slug'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <div id="fastcon_product_product_images_galery_listed"></div>
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <textarea id="product_desc" name="product_desc" rows="5" cols="80"><?= set_value('Product Desc'); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="fastcon_product_spec_uuid" id="fastcon_product_spec_uuid" type="hidden" value="<?= set_value('fastcon_product_spec_uuid'); ?>">
                                <input class="data_file" name="fastcon_product_spec_name" id="fastcon_product_spec_name" type="hidden" value="<?= set_value('fastcon_product_spec_name'); ?>">
                                <small class="info help-block">
                                <b>Extension file must</b> JPG,JPEG,PNG.</small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="fastcon_product_cara_pasang_uuid" id="fastcon_product_cara_pasang_uuid" type="hidden" value="<?= set_value('fastcon_product_cara_pasang_uuid'); ?>">
                                <input class="data_file" name="fastcon_product_cara_pasang_name" id="fastcon_product_cara_pasang_name" type="hidden" value="<?= set_value('fastcon_product_cara_pasang_name'); ?>">
                                <small class="info help-block">
                                <b>Extension file must</b> JPG,JPEG,PNG.</small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="fastcon_product_certificate_uuid" id="fastcon_product_certificate_uuid" type="hidden" value="<?= set_value('fastcon_product_certificate_uuid'); ?>">
                                <input class="data_file" name="fastcon_product_certificate_name" id="fastcon_product_certificate_name" type="hidden" value="<?= set_value('fastcon_product_certificate_name'); ?>">
                                <small class="info help-block">
                                <b>Extension file must</b> JPG,JPEG,PNG.</small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/fastcon_product/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id_spec = $('#fastcon_product_spec_galery').find('li').attr('qq-file-id');
            var id_cara_pasang = $('#fastcon_product_cara_pasang_galery').find('li').attr('qq-file-id');
            var id_certificate = $('#fastcon_product_certificate_galery').find('li').attr('qq-file-id');
            ...
            $('.message').fadeIn();
            resetForm();
            $('#fastcon_product_product_images_galery').find('li').each(function() {
               $('#fastcon_product_product_images_galery').fineUploader('deleteFile', $(this).attr('qq-file-id'));
            });
            if (typeof id_spec !== 'undefined') {
                    $('#fastcon_product_spec_galery').fineUploader('deleteFile', id_spec);
                }
            if (typeof id_cara_pasang !== 'undefined') {
                    $('#fastcon_product_cara_pasang_galery').fineUploader('deleteFile', id_cara_pasang);
                }
            if (typeof id_certificate !== 'undefined') {
                    $('#fastcon_product_certificate_galery').fineUploader('deleteFile', id_certificate);
                }
            $('.chosen option').prop('selected', false).trigger('chosen:updated');
            product_desc.setData('');
