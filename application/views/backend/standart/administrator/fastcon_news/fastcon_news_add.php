...
<section class="content-header">
    <h1>
        News        <small><?= cclang('new', ['News']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['News']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="fastcon_news_image_uuid" id="fastcon_news_image_uuid" type="hidden" value="<?= set_value('fastcon_news_image_uuid'); ?>">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/fastcon_news/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id_image = $('#fastcon_news_image_galery').find('li').attr('qq-file-id');
            ...
            if (typeof id_image !== 'undefined') {
                    $('#fastcon_news_image_galery').fineUploader('deleteFile', id_image);
                }
