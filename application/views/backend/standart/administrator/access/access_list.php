<style type="text/css">
  #search {
	...
	#container_permission label {
		display: block;
		white-space: initial;
	}
	
	#container_permission td p {
		float: right;
		width: calc(100% - 23px);
		line-height: 1.2em;
		padding-top: .2em;
                        ...
                        <div class="tab-content">
                          <div class="tab-pane active" id="tab_1">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped dataTable access-table">
                                	<tbody id="container_permission"></tbody>
