...
<section class="content-header">
    <h1>
        Benefits        <small>Edit Benefits</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Benefits</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/fastcon_benefits/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file data_file_uuid" name="fastcon_benefits_image_uuid" id="fastcon_benefits_image_uuid" type="hidden" value="<?= set_value('fastcon_benefits_image_uuid'); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="title" id="title" placeholder="Title" value="<?= set_value('title', $fastcon_benefits->title); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="title_en" id="title_en" placeholder="Title En" value="<?= set_value('title_en', $fastcon_benefits->title_en); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <textarea id="caption" name="caption" rows="5" class="textarea"><?= set_value('caption', $fastcon_benefits->caption); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <textarea id="caption_en" name="caption_en" rows="5" class="textarea"><?= set_value('caption_en', $fastcon_benefits->caption_en); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: form_fastcon_benefits.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id = $('#fastcon_benefits_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
       ...
       $('#fastcon_benefits_image_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'administrator/fastcon_benefits/get_image_file/<?= $fastcon_benefits->id; ?>',
