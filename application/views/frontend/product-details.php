            ...
            <div class="row product-details-content-wrap">
                ...
                <div class="col-lg-6">
                    <div class="product-details-info-wrap">
                        <h2 class="fastcon-h2 product-title">Bata ringan fastcon (blok STANDARD)</h2>
                        ...
                        <h2 class="fastcon-h2 main-price cl-error">Rp5.000.000</h2>

                        <div class="row">

                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="fastcon-label cl-grey-900">Ketebalan Produk</label>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="fastcon-label cl-grey-900">Ritase</label>
                                    <select class="form-control selectpicker">
                                        <option>10.8 m3</option>
                                        <option>2</option>
                                        <option>3</option>
                                        <option>4</option>
                                        <option>5</option>
                        ...
                        <form class="cart" method="post" enctype='multipart/form-data'>
                            ...
                            <div class="row cart-btn-wrap">
                                <div class="col-sm-12">
                                    <button type="submit" class="fastcon-btn primary-btn">TAMBAH KE TROLI BELANJA</button>
                        ...
                        <div class="tab-container">
                            ...
                            <div class="tab-content clearfix" id="tabs-3">
                                ...
                                <div id="reviews" class="clearfix">
                                    ...
                                    <!-- Modal Reviews
                                    ============================================= -->
                                    <a href="#" data-toggle="modal" data-target="#reviewFormModal" class="button button-3d m-0 float-right">Add a Review</a>
