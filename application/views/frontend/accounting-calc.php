                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12">
                            <div class="form-group">
                                <label for="name" class="fastcon-label cl-grey-900">PANJANG DINDING (m)*</label>
                                <input type="text" value="1" class="form-control" id="name" aria-describedby="emailHelp" placeholder="Ketik disini">
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="form-group">
                                <label for="name" class="fastcon-label cl-grey-900">LEBAR DINDING (m)</label>
                                <input type="text" value="1" class="form-control" id="name" aria-describedby="emailHelp" placeholder="Ketik disini">
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="form-group">
                                <label for="name" class="fastcon-label cl-grey-900">TINGGI DINDING (m)</label>
                                <input type="text" value="1" class="form-control" id="name" aria-describedby="emailHelp" placeholder="Ketik disini">
            ...
            <div class="calc-result-wrap">
                ...
                <div class="row">
                    <div class="col-md-4 col-6 mb-30">
                        ...
                        <h1 class="fastcon-calc-result cl-primary-900">34</h1>
                    </div>

                    <div class="col-md-4 col-6 mb-30">
                        <p class="fastcon-label cl-grey-900">JUMLAH KUBIKASI YANG DIBUTUHKAN (M3)</p>
                        <h1 class="fastcon-calc-result cl-primary-900">0.4</h1>
                    </div>

                    <div class="col-md-4 col-6 mb-30">
                        <p class="fastcon-label cl-grey-900">JUMLAH PEMBELIAN MINIMAL PABRIK (M3)</p>
                        <h1 class="fastcon-calc-result cl-primary-900">11.52</h1>
                    </div>
                </div>
            </div>
        </div>
