<nav class="member-navbar">
    <div class="content-wrap">
        <ul class="member-menu">
            ...
            <li><a href="<?=site_url('member/coupon')?>">KUPON BELANJA (<?=$total_coupon?>)</a></li>
...
<nav class="member-nav medium-small-only">
    <div class="w-100 medium-small-only">
        <select class="form-control selectpicker rounded-0 select-change-page member-nav-select">
            ...
            <option value="<?=site_url('member/coupon')?>">KUPON BELANJA (<?=$total_coupon?>)</option>
            <option value="<?=site_url('member/logout')?>">KELUAR</option>
        </select>
    </div>
</nav>