                                            ...
                                            <div class="col-lg-7 col-md-12">
                                                <div class="card-summary">
                                                    ...
                                                    <?php if ($hg->order_status==1): ?>
                                                        ...
                                                        <div class="card-summary-product-item">
                                                            <div class="price">
                                                                <a href="javascript:void(0)" class="cl-error cancel-btn cancel-order" data-url="<?=site_url('member/cancel_order/'.strtolower($hg->order_code))?>">
...
<div class="modal fade logout-modal" id="cancel_order_modal" tabindex="-1" role="dialog" aria-labelledby="logoutModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-body">
            <div class="modal-content">
                <div class="modal-body">
                    <h2 class="fastcon-h2 cl-grey-900 text-uppercase text-center mb-20"><?=lang('cancel_order')?>?</h2>

                    <p class="fastcon-body-large cl-grey-900 text-center"><?=lang('cancel_order_title')?></p>
                    
                    <div class="btn-wrap">
                        <a href="javascript:void(0)" class="fastcon-btn primary-btn" data-dismiss="modal" aria-hidden="true"><?=lang('discard')?></a>
                        <a class="fastcon-btn secondary-error-btn remove-btn"><?=lang('cancel')?></a>
                    </div>
                </div>
            </div>
        </div>
