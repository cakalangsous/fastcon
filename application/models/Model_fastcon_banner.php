...
class Model_fastcon_banner extends MY_Model {
	...
	public function count_all($q = null, $field = null)
	{
        ...
        if (empty($field)) {
	        foreach ($this->field_search as $field) {
	            if ($iterasi == 1) {
	                $where .= "fastcon_banner.".$field . " LIKE '%" . $q . "%' ";
	            } else {
	                $where .= "OR " . "fastcon_banner.".$field . " LIKE '%" . $q . "%' ";
	            }
	            $iterasi++;
	        }
	...
	public function get($q = null, $field = null, $limit = 0, $offset = 0, $select_field = [])
	{
	    ...
	    $this->db->order_by('fastcon_banner.'.$this->primary_key, "DESC");
        if (isset($_GET['order'])) {
...
/* End of file Model_fastcon_banner.php */
/* Location: ./application/models/Model_fastcon_banner.php */